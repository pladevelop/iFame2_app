...
ifameApp.controller('loginController', [
        ...
        function($scope, $state, $ionicLoading, $q, appConstants, appGlobals,
            ...
            function init() {
                // default login value
                 $scope.user.userId = "" 
                 $scope.user.userPwd = ""
                 $scope.user.userId = "bradmin1"     //=====//"40007430";//"bradmin1" //"45031169" // "39016994"; //"50012011";
                 $scope.user.userPwd = "backoffic"     //=====//"12345678"; //"backoffic"// "32006007" // "password"; //"249720";
    ...
    .controller('sidemenuController', [
        '$scope', '$state', 'sharedFactory', 'sessionFactory',
        function($scope, $state, sharedFactory, sessionFactory) {
            // declaration
            $scope.sideMenus = [];
            // initialize
            init();
