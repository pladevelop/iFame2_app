...
ifameApp.controller('teamController', [
    ...
    .controller('teamunder_smpremController', [
        ...
        function($scope, appGlobals, sharedFactory, teamFactory, $state, $timeout, $stateParams) {
            ...
            function showLevel(level, agCode, agName, agStatus, agRank, agLnkrk) {
                ...
                // submition
                var promise = teamFactory.getSubmitPrem(agCode, $scope.usrGroup);
                promise.success(function(data, status, headers, config, statusText) {
                        //alert('OK' + JSON.stringify(data));
                        if (angular.isUndefined(data) || data === null) {
                            $scope.smprems = [];
                            ...
                            $scope.smprems = teamFactory.getDefaultSubmit();
                        } else {
                            $scope.smprems = data;
                            //$ionicLoading.hide();
                        }
            ...
            $scope.changeAgent = function(ag) {
                if ($scope.curlevel < 5) {
                    ...
                    if (isAgRank || isSelf) {
                        ...
                        $state.go("menu.teamagent_smprem", params);
                    } else {
                        $scope.curlevel += 1;
                        showLevel(
                            $scope.curlevel,
    ...
    .controller('teamunder_ispremController', [
        ...
        function($scope, appGlobals, sharedFactory, teamFactory, $state, $timeout, $stateParams) {
            ...
            function showLevel(level, agCode, agName, agStatus, agRank, agLnkrk) {
                ...
                // sissue
               var promise = teamFactory.getIssuePrem(agCode, $scope.usrGroup);
                promise.success(function(data, status, headers, config, statusText) {
                        //alert('OK' + JSON.stringify(data));
                        if (angular.isUndefined(data) || data === null) {
                            $scope.isprems = [];
                            //$ionicLoading.hide();
                            sharedFactory.showMsg(msgTitle, "No Data!");
                            $scope.isprems = teamFactory.getDefaultIssue();
                        } else {
                            $scope.isprems = data;
                            //$ionicLoading.hide();
                        }
            ...
            $scope.changeAgent = function(ag) {
                if ($scope.curlevel < 5) {
                    ...
                    if (isAgRank || isSelf) {
                        ...
                        $state.go("menu.teamagent_isprem", params);
                    } else {
                        $scope.curlevel += 1;
                        showLevel(
                            $scope.curlevel,
    ...
    .controller('teamagentController', [
        '$scope', '$ionicLoading', 'sharedFactory', 'teamFactory', 'appGlobals', '$q', '$stateParams', '$state',
        function($scope, $ionicLoading, sharedFactory, teamFactory, appGlobals, $q, $stateParams, $state) {
            var msgTitle = "Team";
            // declaration
            $scope.agCode = "";
            $scope.agLnkrk = "";
            ...
            // submition
                ...
                var promise = teamFactory.getSubmitPrem($scope.agCode , $scope.usrGroup);
                promise.success(function(data, status, headers, config, statusText) {
                        //alert('OK' + JSON.stringify(data));
                        if (angular.isUndefined(data) || data === null) {
                            $scope.smprems = [];
    ...
    .controller('teamagentisController', [
        ...
        function($scope, $ionicLoading, sharedFactory, teamFactory, appGlobals, $q, $stateParams, $state) {
            ...
            function init() {
             ...
             // sissue
               var promise = teamFactory.getIssuePrem($scope.agCode , $scope.usrGroup);
                promise.success(function(data, status, headers, config, statusText) {
                        //alert('OK' + JSON.stringify(data));
                        if (angular.isUndefined(data) || data === null) {
                            $scope.isprems = [];
    ...
    .controller('teamall_smpremController', [
        ...
        function($scope, $ionicLoading, appGlobals, sharedFactory, teamFactory, $state) {
            ...
            function init() {
                ...
                // submition
                var promise = teamFactory.getSubmitPrem($scope.usrId, $scope.usrGroup);
                promise.success(function(data, status, headers, config, statusText) {
                        //alert('OK' + JSON.stringify(data));
                        if (angular.isUndefined(data) || data === null) {
                            $scope.smprems = [];
            ...
            $scope.showAgentUnder = function(agCode) {
                ...
                $state.go("menu.teamunder_smprem", data);
            };
        }
    ])
.controller('teamall_ispremController', [
        ...
        function($scope, $ionicLoading, appGlobals, sharedFactory, teamFactory, $state) {
            ...
            function init() {
               ...
               var promise = teamFactory.getIssuePrem($scope.usrId, $scope.usrGroup);
                promise.success(function(data, status, headers, config, statusText) {
                        //alert('OK' + JSON.stringify(data));
                        if (angular.isUndefined(data) || data === null) {
                            $scope.isprems = [];
            ...
            $scope.showAgentUnder = function(agCode) {
                ...
                $state.go("menu.teamunder_isprem", data);
            };
        }
    ])
    //
