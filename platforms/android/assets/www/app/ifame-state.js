...
ifameApp.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, $httpProvider, $cordovaInAppBrowserProvider) {
    ...
    $stateProvider
        ...
        .state('menu.homesuper', {
            url: "/homesuper",
            views: {
                'menuContent': {
                    templateUrl: "views/homesuper.html",
                    controller: "homesuperController"
                }
            }
        })
        .state('menu.homebranch', {
            url: "/homebranch",
            views: {
                'menuContent': {
                    templateUrl: "views/homebranch.html",
                    controller: "homebranchController"
                }
            }
        })
        .state('menu.homecustomer', {
            ...
            views: {
                'menuContent': {
                    templateUrl: "views/homecustomer.html",
        ...
        .state('menu.policyinforce', {
            url: "/policyinforce/:stsqry/:polId/:insuredNm/:insuredSn",
            views: {
                'menuContent': {
        ...
        .state('menu.teamall_smprem', {
            url: "/teamall_smprem",
            views: {
                'menuContent': {
                    templateUrl: "views/team/teamall_smprem.html",
                    controller: "teamall_smpremController"
                }
            }
        })
        .state('menu.teamunder_smprem', {
            url: "/teamunder_smprem/:agCode",
            views: {
                'menuContent': {
                    templateUrl: "views/team/teamunder_smprem.html",
                    controller: "teamunder_smpremController"
                }
            }
        })
        .state('menu.teamall_isprem', {
            url: "/teamall_isprem",
            views: {
                'menuContent': {
                    templateUrl: "views/team/teamall_isprem.html",
                    controller: "teamall_ispremController"
                }
            }
        })
        .state('menu.teamunder_isprem', {
            url: "/teamunder_isprem/:agCode",
            views: {
                'menuContent': {
                    templateUrl: "views/team/teamunder_isprem.html",
                    controller: "teamunder_ispremController"
                }
            }
        })
        .state('menu.policyunderquery', {
            url: "/policyunderquery",
            views: {
                'menuContent': {
                    templateUrl: "views/team/policyunderquery.html",
                    controller: "polunderqueryController"
                }
            }
        })
        ...
        .state('menu.teamagent_smprem', {
            url: "/teamagent_smprem/:agCode/:agLnkrk",
            views: {
                'menuContent': {
                    templateUrl: "views/team/teamagent_smprem.html",
                    controller: "teamagentController"
                }
            }
        })
        .state('menu.teamagent_isprem', {
            url: "/teamagent_isprem/:agCode/:agLnkrk",
            views: {
                'menuContent': {
                    templateUrl: "views/team/teamagent_isprem.html",
                    controller: "teamagentisController"
                }
            }
        })
